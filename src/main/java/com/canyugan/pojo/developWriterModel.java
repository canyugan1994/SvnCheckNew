...
public class developWriterModel extends BaseRowModel {
    ...
    @ExcelProperty(value = "技术立项申请单",index = 17)
    private Integer tecproject_applicationform;

    @ExcelProperty(value = "立项申请报告",index = 18)
    private Integer project_applicationreport;

    @ExcelProperty(value = "立项采购合同",index = 19)
    private Integer project_procurementcontract;

    @ExcelProperty(value = "概要设计",index = 20)
    private Integer summary_design;
    
    @ExcelProperty(value = "数据库设计",index = 21)
    private Integer database_design;

    @ExcelProperty(value = "系统运维手册",index = 22)
    private Integer system_maintenancemanual;

    @ExcelProperty(value = "系统应急手册",index = 23)
    private Integer system_emergencymanual;

    @ExcelProperty(value = "系统安装手册",index = 24)
    private Integer system_installationmanual;

    @ExcelProperty(value = "启动PPT",index = 25)
    private Integer start_ppt;

    @ExcelProperty(value = "启动会议纪要",index = 26)
    private Integer start_meetingminutes;
    
    @ExcelProperty(value = "项目进度计划" ,index = 27)
    private Integer project_schedule;

    @ExcelProperty(value = "项目里程碑",index = 28)
    private Integer project_milestone;

    @ExcelProperty(value = "项目配置管理计划",index = 29)
    private Integer project_configurationplan;

    @ExcelProperty(value = "风险列表及跟踪记录",index = 30)
    private Integer risklist_trackingrecord;

    @ExcelProperty(value = "项目问题日志",index = 31)
    private Integer project_problemlog;
    
    @ExcelProperty(value = "项目成员技能识别" ,index = 32)
    private Integer projectmemberskill_recognition;

    @ExcelProperty(value = "培训记录表",index = 33)
    private Integer training_record;

    @ExcelProperty(value = "项目月报",index = 34)
    private Integer project_monthlyreport;

    @ExcelProperty(value = "里程碑报告",index = 35)
    private Integer milestone_report;

    @ExcelProperty(value = "质量保证",index = 36)
    private Integer quality_assurance;

    @ExcelProperty(value = "会议纪要",index = 37)
    private Integer minutes_meeting;

    @ExcelProperty(value = "通讯录",index = 38)
    private Integer address_book;

    @ExcelProperty(value = "项目验收申请表",index = 39)
    private Integer projectacceptance_applicationform;

    @ExcelProperty(value = "项目结项申请表",index = 40)
    private Integer projectcompletion_applicationform;
    
    @ExcelProperty(value = "项目总结报告",index = 41)
    private Integer project_summaryreport;

    @ExcelProperty(value = "项目预研报告",index = 42)
    private Integer project_preresearchreport;

    @ExcelProperty(value = "详细设计",index = 43)
    private Integer detailed_design;

    @ExcelProperty(value = "设计评审报告",index = 44)
    private Integer designreview_report;

    @ExcelProperty(value = "用户操作手册",index = 45)
    private Integer useroperation_manual;

    @ExcelProperty(value = "性能测试计划",index = 46)
    private Integer performance_testplan;
    
    @ExcelProperty(value = "性能测试报告" ,index = 47)
    private Integer performance_testreport;

    @ExcelProperty(value = "压力测试案例",index = 48)
    private Integer stress_testcase;

    @ExcelProperty(value = "压力测试报告",index = 49)
    private Integer stress_testreport;

    @ExcelProperty(value = "安全测试报告",index = 50)
    private Integer safety_testreport;

    @ExcelProperty(value = "测试评审报告",index = 51)
    private Integer test_reviewreport;
    
    @ExcelProperty(value = "数据库规格说明书" ,index = 52)
    private Integer database_specification;

    @ExcelProperty(value = "变更影响分析",index = 53)
    private Integer change_impactaanalysis;

    @ExcelProperty(value = "重大模块、功能、批处理等补充说明",index = 54)
    private Integer supplementary_explanation;

    @ExcelProperty(value = "必交文档提交率",index = 55)
    private String must_rate;

    @ExcelProperty(value = "选交文档提交率",index = 56)
    private String selected_rate;

    @ExcelProperty(value = "备注",index = 57)
